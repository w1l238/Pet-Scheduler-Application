...
import './ClientCalendarPage.css'; // Import animation styles

function ClientCalendarPage() {
    usePageTitle('Client - Calendar', '/favicon.ico'); // Set the page title and favicon
    ...
    useEffect(() => {
        const fetchAppointments = async () => {
            try {
                const response = await api.get('/client/appointments'); // Fetch client-specific appointments
