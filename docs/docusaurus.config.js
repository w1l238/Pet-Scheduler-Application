...
const config = {
  title: 'Pet Scheduler Application',
  tagline: 'Documentation for the Pet Scheduler Application',
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Pet Scheduler Application, Inc. Built with Docusaurus.`,
      },
      prism: {
