...
This guide will walk you through the steps to set up and run the Pet Scheduler Application on your local machine.
...
Edit the `.env` file in the `backend` directory with your chosen editor(This documentation will use nano for this). This file will store your database credentials and other sensitive information.
...
1.  **Create the Database:**
    Open your PostgreSQL client (e.g., `psql`) and create a new database named `pet_scheduler_db` (You can create any name but make sure to reflect that in your .env file, we will use 'pet_scheduler_db' this example):
